...
def measure_query_time(conn, n=200):
    """Measure query time for the given conn, n."""
...
if __name__ == "__main__":
    ...
    print(
        "Difference is small at this dataset size (see module docstring) — "
        "added as forward-looking practice, not a fix for an observed bottleneck."
    )
