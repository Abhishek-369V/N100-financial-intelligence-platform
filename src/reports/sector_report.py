...
styles = {
    ...
    "section_header": ParagraphStyle("section_header", fontSize=11, textColor=NAVY, fontName="Helvetica-Bold", spaceBefore=10, spaceAfter=6),
...
def build_sector_report(sector_name, sector_df):
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=2.4 * cm, bottomMargin=1.2 * cm, leftMargin=1.5 * cm, rightMargin=1.5 * cm,
    )
...
if __name__ == "__main__":
    ...
    print(f"Sector PDFs generated: {len(generated)} (spec assumed 11; actual data has {len(generated)} distinct broad_sector values)")
